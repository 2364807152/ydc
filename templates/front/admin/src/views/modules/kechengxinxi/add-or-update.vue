...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../django6i9a9/upload');
	this.ruleForm.kechengbiao = this.ruleForm.kechengbiao.replace(reg,'../../../django6i9a9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
