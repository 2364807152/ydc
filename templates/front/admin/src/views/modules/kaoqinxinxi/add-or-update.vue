<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到次数" prop="qiandaocishu">
          <el-input v-model="ruleForm.qiandaocishu" 
              placeholder="签到次数" clearable  :readonly="ro.qiandaocishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到次数" prop="qiandaocishu">
              <el-input v-model="ruleForm.qiandaocishu" 
                placeholder="签到次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="旷课次数" prop="kuangkecishu">
          <el-input v-model="ruleForm.kuangkecishu" 
              placeholder="旷课次数" clearable  :readonly="ro.kuangkecishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="旷课次数" prop="kuangkecishu">
              <el-input v-model="ruleForm.kuangkecishu" 
                placeholder="旷课次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='qiandaocishu'){
            this.ruleForm.qiandaocishu = obj[o];
	    this.ro.qiandaocishu = true;
            continue;
          }
          if(o=='qingjiacishu'){
	    ...
	    this.ro.chidaocishu = true;
          ...
          if(o=='kuangkecishu'){
            this.ruleForm.kuangkecishu = obj[o];
	    this.ro.kuangkecishu = true;
            continue;
          }
          if(o=='dengjishijian'){
